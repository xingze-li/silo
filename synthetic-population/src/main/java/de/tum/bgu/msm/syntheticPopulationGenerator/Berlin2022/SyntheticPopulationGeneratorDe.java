...
import de.tum.bgu.msm.syntheticPopulationGenerator.properties.Berlin2022PropertiesSynPop;
...
public class SyntheticPopulationGeneratorDe {
    ...
    public static void main (String[] args) {
        ...
        try {
            PropertiesSynPop.initializePropertiesSynPop(new Berlin2022PropertiesSynPop(new PropertyResourceBundle(new FileReader(args[0]))));
